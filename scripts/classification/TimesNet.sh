...
python -u run.py --task_name classification --is_training 1 --root_path $root_path/BTC/ --data_path BTC.csv --model_id BTC --model TimesNet --data custom --e_layers 3 --batch_size 16 --d_model 32 --d_ff 32 --top_k 3 --des 'Exp' --itr 1 --learning_rate 0.001 --train_epochs 30 --patience 10